...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: CharactersWidget.routeName,
          path: CharactersWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Characters')
              : CharactersWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: EpisodesWidget.routeName,
          path: EpisodesWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Episodes')
              : EpisodesWidget(),
        )
